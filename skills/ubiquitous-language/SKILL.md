...
4. **Write to `docs/UBIQUITOUS_LANGUAGE.md`** if the repo keeps a `docs/` folder (the glossary is a library doc, not a root doc); fall back to `UBIQUITOUS_LANGUAGE.md` at the working-directory root otherwise. If an INDEX of docs exists, add a line for it
